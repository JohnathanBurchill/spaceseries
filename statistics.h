...
#ifndef _SPACESERIES_STATISTICS_H
#define _SPACESERIES_STATISTICS_H
...
enum SPACESERIES_STATISTICS_STATUS
{
    SPACESERIES_STATISTICS_OK = 0,
    SPACESERIES_STATISTICS_MEM,
    SPACESERIES_STATISTICS_NO_DATA,
    SPACESERIES_STATISTICS_POINTER,
    SPACESERIES_STATISTICS_UNSUPPORTED_STATISTIC    
};
